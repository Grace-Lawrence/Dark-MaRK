...
from darkmark.freq_eq import reduced_mass_ratio
from darkmark import GeVc2

__all__ = ["Detector", "DM", "VDF", "Nibbler","day_to_date", 
...
def calc_real_vE(calc_day, v_E = 'Astropy'):
    """
    Calculate the speed of the Earth on a given day using methods outlined in 
    different publications.

    Parameters
    ----------
    calc_day : Integer, float or array of.
        Time (in days) to calculate the speed at.
    v_E : String, optional
        Method for calculating the velocity. The default is 'Astropy'.

    Returns
    -------
    earth_speed : Float or array of floats.
...
def calc_real_uE(calc_day,comp):
    ...
    calc_day : Integer, float or array of.
        Time (in days) to calculate the speed at.
    comp : String
        Option of 'x','y','z' to calculate the speed component of the Earth. 
